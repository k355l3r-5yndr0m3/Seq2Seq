...
if load_latest_checkpoint(model, optimizer, scheduler):
    print("restart from checkpoint.")
else:
    print("training from scratch.")

with open("losses_graph", "a", buffering=1) as graph, open("translation_test", "a", buffering=1) as translation:
    for epoch in range(82, epoch_num):
